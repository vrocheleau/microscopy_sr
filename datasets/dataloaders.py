...
def get_datasets(splits_dir, chanels, scale_factor, patch_size, preload=False, augment=False):
    ...
    test_ds = SrDataset(test_csv, chanels, scale_factor, patch_size, trans, preload, augment)
    val_ds = SrDataset(val_csv, chanels, scale_factor, patch_size, trans, preload, augment)
